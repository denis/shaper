...
/***/ function(module, exports, __webpack_require__) {
	...
	var reducers_ts_1 = __webpack_require__(27);
	var Editor_tsx_1 = __webpack_require__(34);
	var store = redux_1.createStore(reducers_ts_1.shaperApp);
	react_dom_1.render(React.createElement(react_redux_1.Provider, {store: store}, React.createElement(Editor_tsx_1.Editor, null)), document.getElementById("shaper"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions_ts_1 = __webpack_require__(33);
	var initialState = {
	    shapes: []
	};
	function shaperApp(state, action) {
	    if (state === void 0) { state = initialState; }
	    switch (action.type) {
	        case actions_ts_1.ADD_SHAPE:
	            return addShape(state, action);
	        case actions_ts_1.MOVE_SHAPE:
	            return moveShape(state, action);
	        case actions_ts_1.BRING_SHAPE_FORWARD:
	            return bringShapeForward(state, action);
	        default:
	            return state;
	    }
	}
	exports.shaperApp = shaperApp;
	function addShape(state, action) {
	    var shape;
	    var shapeType = action.shapeType, x = action.x, y = action.y;
	    var size = 80;
	    if (shapeType == "circle") {
	...
	function moveShape(state, action) {
	    return Object.assign({}, state, {
	        shapes: state.shapes.map(function (shape, index) {
	...
	function bringShapeForward(state, action) {
	    return Object.assign({}, state, {
	        shapes: state.shapes.concat([state.shapes[action.shapeIndex]])
	    });
	}
...
/***/ function(module, exports) {
	...
	"use strict";
	var Shape = (function () {
	    function Shape(_x, _y, _size, _fillColor) {
	        if (_fillColor === void 0) { _fillColor = "#aaa"; }
	        this._x = _x;
	        this._y = _y;
	        this._size = _size;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shape_ts_1 = __webpack_require__(29);
...
/***/ function(module, exports) {
	...
	exports.MOVE_SHAPE = "MOVE_SHAPE";
	exports.BRING_SHAPE_FORWARD = "BRING_SHAPE_FORWARD";
	function addShape(shapeType, x, y) {
	    return {
	        type: exports.ADD_SHAPE,
	        shapeType: shapeType,
	        x: x,
	        y: y
	    };
	...
	function moveShape(shapeIndex, x, y) {
	    return {
	        type: exports.MOVE_SHAPE,
	...
	function bringShapeForward(shapeIndex, x, y) {
	    return {
	        type: exports.BRING_SHAPE_FORWARD,
	        shapeIndex: shapeIndex,
	        x: x,
	        y: y
	    };
	}
	exports.bringShapeForward = bringShapeForward;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Palette_tsx_1 = __webpack_require__(35);
	var CanvasShapes_ts_1 = __webpack_require__(40);
	var Editor = (function (_super) {
	    ...
	    Editor.prototype.render = function () {
	        return React.createElement("div", {className: "editor"}, React.createElement(Palette_tsx_1.Palette, {size: "40"}), React.createElement(CanvasShapes_ts_1.CanvasShapes, null));
	    };
	    return Editor;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PaletteItem_tsx_1 = __webpack_require__(36);
	var Palette = (function (_super) {
	    ...
	    Palette.prototype.render = function () {
	        return React.createElement("div", {className: "palette"}, React.createElement(PaletteItem_tsx_1.PaletteItem, {shapeType: "circle", size: this.props.size}), React.createElement(PaletteItem_tsx_1.PaletteItem, {shapeType: "square", size: this.props.size}), React.createElement(PaletteItem_tsx_1.PaletteItem, {shapeType: "triangle", size: this.props.size}));
	    };
	    return Palette;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Circle_tsx_1 = __webpack_require__(37);
	var Square_tsx_1 = __webpack_require__(38);
	var Triangle_tsx_1 = __webpack_require__(39);
	var models = __webpack_require__(28);
	var PaletteItem = (function (_super) {
	    ...
	    PaletteItem.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", {className: "palette-item", draggable: "true", onDragStart: function (e) { _this.dragStart(e, _this.props.shapeType); }}, React.createElement("svg", {width: this.props.size, height: this.props.size}, this.renderShape(this.props.shapeType)));
	    };
	    PaletteItem.prototype.renderShape = function (shapeType) {
	    ...
	    PaletteItem.prototype.dragStart = function (event, shapeType) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_redux_1 = __webpack_require__(3);
	var actions_ts_1 = __webpack_require__(33);
	var canvas_tsx_1 = __webpack_require__(41);
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        onDrop: function (shapeType, x, y) {
	            dispatch(actions_ts_1.addShape(shapeType, x, y));
	        },
	        onMouseMove: function (shapeId, x, y) {
	            dispatch(actions_ts_1.moveShape(shapeId, x, y));
	        },
	        onDoubleClick: function (shapeId, x, y) {
	            dispatch(actions_ts_1.bringShapeForward(shapeId, x, y));
	        }
	    };
	}
	exports.CanvasShapes = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(canvas_tsx_1.Canvas);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CanvasItem_tsx_1 = __webpack_require__(42);
	var Canvas = (function (_super) {
	    ...
	    Canvas.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", {className: "canvas", onDragOver: function (e) { _this.dragOver(e); }, onDrop: function (e) { _this.drop(e); }}, React.createElement("svg", {ref: "svg"}, this.props.shapes.map(function (shape, i) {
	            return React.createElement(CanvasItem_tsx_1.CanvasItem, {shape: shape, key: i, onMouseDown: function (shape, e) { _this.shapeMouseDown(shape, e); }, onDoubleClick: function (shape, e) { _this.shapeDoubleClick(shape, e); }});
	        })));
	    };
	    ...
	    Canvas.prototype.drop = function (event) {
	        ...
	        this.props.onDrop(event.dataTransfer.getData("shapeType"), x, y);
	    };
	    ...
	    Canvas.prototype.windowMouseUp = function (event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CanvasItem = (function (_super) {
	    ...
	    CanvasItem.prototype.render = function () {
	        var _this = this;
	        return React.createElement("g", {onMouseDown: function (e) { _this.onMouseDown(e); }, onDoubleClick: function (e) { _this.onDoubleClick(e); }}, this.renderShape(this.props.shape));
	    };
	    ...
	    CanvasItem.prototype.onDoubleClick = function (event) {
