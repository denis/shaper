...
/***/ function(module, exports, __webpack_require__) {
	...
	var Canvas = (function (_super) {
	    ...
	    Canvas.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", {className: "canvas", onDrop: function (e) { _this.drop(e); }, onDragOver: function (e) { _this.dragOver(e); }}, React.createElement("svg", {ref: "svg"}, this.state.shapes.map(function (shape) {
	            return _this.renderShape(shape);
	        })));
	    };
	    Canvas.prototype.renderShape = function (shape) {
	        var key = Math.random();
	        if (shape instanceof models.Circle) {
	            return React.createElement(Circle_tsx_1.Circle, {shape: shape, key: key});
	        }
	        else if (shape instanceof models.Square) {
	            return React.createElement(Square_tsx_1.Square, {shape: shape, key: key});
	        }
	        else if (shape instanceof models.Triangle) {
	            return React.createElement(Triangle_tsx_1.Triangle, {shape: shape, key: key});
	        }
	    };
	    ...
	    Canvas.prototype.drop = function (event) {
	        ...
	        var centerX = event.pageX - rect.left;
	        var centerY = event.pageY - rect.top;
	        var size = 80;
	        if (shapeType == "circle") {
